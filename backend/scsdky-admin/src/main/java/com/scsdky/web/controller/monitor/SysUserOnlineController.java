...
import com.scsdky.system.domain.SysUserOnline;
import com.scsdky.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    public TableDataInfo list(String ipaddr, String userName)
    {
        ...
        for (String key : keys)
        {
            ...
            LoginUser user = JSONObject.toJavaObject(jsonObject,LoginUser.class);
