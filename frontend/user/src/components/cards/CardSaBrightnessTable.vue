<template>
  <div class="card-sa card-sa-brightness-table">
...
const columns = [
  ...
  { label: '洞外亮度最大值(cd/㎡)', value: 'maxOutside' },
  { label: '洞外亮度最小值（cd/㎡）', value: 'minOutside' },
  { label: '洞外亮度平均值（cd/㎡）', value: 'avgOutside' },
  { label: '调光比例最大值（%）', value: 'maxDimmingRadio' },
  { label: '调光比例最小值（%）', value: 'minDimmingRadio' },
  { label: '调光比例平均值（%）', value: 'avgDimmingRadio' },
  { label: '亮暗灯时长对比', value: 'lightRadio' },
]
